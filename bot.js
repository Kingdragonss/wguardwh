...
client.on('ready', async () => {
 ...
 client.user.setActivity(`🔱King Of HYDRA🔱`, { type:'WATCHİNG' })
  
  console.log("🔱King Of HYDRA🔱")
});
          ...
          try {
            if (!msg.member.permissions.has("BAN_MEMBERS")) {
                  msg.delete();
                      ...
                      return msg.reply('**<a:hydracrown3:816355855179841557> Heey! Küfür Yasak !** <a:hydratatlis:792780559704391711>').then(nordx => nordx.delete({timeout: 5000}))
            }              
          } catch(err) {
            console.log(err);
          }
